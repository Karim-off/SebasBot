  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝒌𝒂𝒓𝒊𝒎👑;;;\nFN:𝒌𝒂𝒓𝒊𝒎👑\nORG:𝒌𝒂𝒓𝒊𝒎👑\nTITLE:\nitem1.TEL;waid=59168683798+591 68683798\nitem1.X-ABLabel:𝒌𝒂𝒓𝒊𝒎👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:𝚔𝙰𝚁𝙸𝙼👑\nEND:VCARD`;
        await this.sendMessage(nk.from, {contacts: {displayName: '𝒌𝒂𝒓𝒊𝒎👑', contacts: [{vcard}]}}, {quoted: callmsg});
...
global.dfail = (type, m, conn) => {
  const msg = {
    ...
    private: '[🌹𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔🌹] 𝑼𝑺𝑨 𝑬𝑺𝑻𝑬 𝑪𝑶𝑴𝑨𝑵𝑫𝑶 𝑨𝑳 𝑪𝑯𝑨𝑻 𝑷𝑹𝑰𝑽𝑨𝑻𝑬 𝑫𝑬 𝑺𝑬𝑩𝑨𝑺 𝑩𝑶𝑻',
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '[ 🛑 ] 𝐀𝐕𝐈𝐒𝐎 - 𝐀𝐋𝐄𝐑𝐓𝐀', body: ' 𝑺𝑬𝑩𝑨𝑺 𝑩𝑶𝑻', thumbnail: imagen1, sourceUrl: global.md}}}}, aa);
